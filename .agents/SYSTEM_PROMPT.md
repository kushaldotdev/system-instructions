...
- Before first Plan, Review, or Implement, root and subagents read `[RULES_FILE]` once.
...
- Checkpoint at ~50 turns, after verified implementation, or after review bugs. If declined, remind at 70, 90, then every 20 turns. Ask first; read `CHECKPOINT.md.template`; write `.agents/state/YYYY-MM-DD-HH-MM-SS-<descriptive-kebab-case-slug>.md`; say `Resume from .agents/state/<file>`.
